...
void biquad_imuf_init(float filterCutFreq, biquad_axis_state_t *state, float refreshRateSeconds, int filterType, float bandwidth)
{
...
float biquad_imuf_update(float sample, biquad_axis_state_t *state)
{
    float result;
